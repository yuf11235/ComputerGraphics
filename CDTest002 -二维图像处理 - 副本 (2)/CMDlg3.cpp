...
void CCMDlg3::OnButton2() 
{
	...
	m_pView3->GetMatrix(m_pView3->m_Matrix, 0, 0, (-1)*x_ledge, (-1)*y_ledge, 0);

	m_pView3->GetMatrix(m_Matrix0, 6, 0, 0, 0, ratio);
	m_pView3->MatrixXMatrix(m_pView3->m_Matrix, m_Matrix0);

	m_pView3->GetMatrix(m_Matrix0, 0, 0, x_ledge, y_ledge, 0);
	m_pView3->MatrixXMatrix(m_pView3->m_Matrix, m_Matrix0);
